...
{
	int row=2000,n=3,m=(13*n)+1;
	
	String savedarray = "iso/"+m+","+n+"isobefore.txt";
	int i,j,count=0;
 ...
 // The counting starts in this method.
    private void operation()
	{
		...
		// this function writes the labeled matrix to a text file
	private void write() throws IOException 
	{
		...
		BufferedWriter writer = new BufferedWriter(new FileWriter("iso/"+m+","+n+"isoafter.txt"));
